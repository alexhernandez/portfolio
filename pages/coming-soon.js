...
export default function ComingSoon() {
  return (
    ...
    <div class="section">
        <div class="nav">
            <Link href="/"><a class="brand">Alex Hernandez</a></Link>
        </div>
        <div class="content">
        <ul class="list-inline social-icons">
            <li><a href="https://github.com/alexhernandez" class="ion-social-github" target="_blank" title="GitHub Profile"></a></li>
            <li><a href="https://dribbble.com/alexhernandez" class="ion-social-dribbble-outline" target="_blank" title="Dribbble Profile"></a></li>
            <li><a href="https://www.linkedin.com/in/alex-hdz" class="ion-social-linkedin-outline" target="_blank" title="LinkedIn Profile"></a></li>
        </ul>
