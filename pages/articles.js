            ...
            <div className="row">
                <div className="col-md-8 offset-md-2">
                    ...
                    <ul className="list--unstyled list--inline pills type--red">
                        ...
                        <li><Link href="/articles"><a className="active">Articles</a></Link></li>
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div style={{padding: "20px"}}>
                                <div className="row">
                                    <div className="col-sm-12">
                                        <h2><a className="type--no-decoration" target="_blank" href="https://medium.com/@oorangecchicken/making-sense-of-device-resolution-pixel-density-40922aeb8a6">Making Sense of Device Resolution &amp; Pixel Density</a></h2>
                                        <p className="type--gray-dark emphasis">June 11, 2018 &middot; 5min Read</p>
                                        <p className="type--red"><a target="_blank" href="https://medium.com/@oorangecchicken/making-sense-of-device-resolution-pixel-density-40922aeb8a6">Read Article on Medium &rarr;</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div style={{borderTop: "1px solid #ccc", padding: "20px"}}>
                                <div className="row">
                                    <div className="col-sm-12">
                                        <h2><a className="type--no-decoration" target="_blank" href="https://medium.com/csun-metalab/creating-a-simple-mobile-first-grid-system-1e883a85fa3f">Creating A Simple Mobile-first Grid System</a></h2>
                                        <p className="type--gray-dark emphasis">January 26, 2018 &middot; 5min Read</p>
                                        <p className="type--red"><a target="_blank" href="https://medium.com/csun-metalab/creating-a-simple-mobile-first-grid-system-1e883a85fa3f">Read Article on Medium &rarr;</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
